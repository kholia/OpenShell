...
# Optional PVM mode. Configure both paths together; QEMU must be on PATH.
# pvm_kernel      = "/opt/openshell/pvm/vmlinux-guest"
# pvm_firmware    = "/opt/openshell/pvm/qboot.rom"
